...
public class CreateTeamPlayerInviteViewModel : IMapFrom<TeamPlayerInvite>
{
    public required TeamPlayerInviteDto Invite { get; set; }

    public void Mapping(Profile profile) => profile.CreateMap<TeamPlayerInvite, CreateTeamPlayerInviteViewModel>()
