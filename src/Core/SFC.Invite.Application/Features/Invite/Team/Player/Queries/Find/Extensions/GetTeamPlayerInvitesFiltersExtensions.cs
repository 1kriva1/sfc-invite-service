...
public static class GetTeamPlayerInvitesFiltersExtensions
{
    ...
    private static Expression<Func<TeamPlayerInvite, bool>> FilterByStat(int? skill, short? from, short? to)
    {
        if (from.HasValue)
        {
    ...
    private static Expression<Func<TeamPlayerInvite, bool>> FilterByRaiting(int? raiting)
    {
