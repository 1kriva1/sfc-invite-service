...
public static class SwaggerExtensions
{
    ...
    private const string TITLE = "SFC.Invite";
    private const string SECURITY_ID = "SFC.Invite - Bearer";
    ...
    public static void AddSwagger(this WebApplicationBuilder builder)
    {
        builder.Services.AddSwaggerGen(setupAction =>
        {
            setupAction.SwaggerDoc(SPECIFICATION_NAME, new()
            {
                Title = TITLE,
                Version = "1",
                Description = "Through this API you can create, update, get and find information about Invites.",
                Contact = new()
                {
    ...
    private static string GetCustomSchemaId(Type type)
    {
        ...
        string modelsPart = "SFC.Invite.Api.Infrastructure.Models.Invites.";
