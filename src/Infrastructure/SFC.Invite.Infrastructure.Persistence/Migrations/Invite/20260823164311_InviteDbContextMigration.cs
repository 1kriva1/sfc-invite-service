...
namespace SFC.Invite.Infrastructure.Persistence.Migrations.Invite
{
    /// <inheritdoc />
    public partial class InviteDbContextMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamePlayerStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamIndexes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Games_Users_LastModifiedBy",
                        column: x => x.LastModifiedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availabilities_Games_Id",
                        column: x => x.Id,
                        principalSchema: "Game",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    FreeGame = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialProfiles_Games_Id",
                        column: x => x.Id,
                        principalSchema: "Game",
                        principalTable: "Games",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeneralProfiles_Games_Id",
                        column: x => x.Id,
                        principalSchema: "Game",
                        principalTable: "Games",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    ShirtsRequired = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ShirtsCount = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventaryProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventaryProfiles_Games_Id",
                        column: x => x.Id,
                        principalSchema: "Game",
                        principalTable: "Games",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GameId = table.Column<long>(type: "bigint", nullable: false),
                    GameComment = table.Column<string>(type: "nvarchar(1050)", maxLength: 1050, nullable: false),
                    PlayerId = table.Column<long>(type: "bigint", nullable: false),
                    PlayerComment = table.Column<string>(type: "nvarchar(1050)", maxLength: 1050, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamePlayerInvites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GamePlayerInvites_Games_GameId",
                        column: x => x.GameId,
                        principalSchema: "Game",
                        principalTable: "Games",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GamePlayerInvites_InviteStatuses_StatusId",
                        column: x => x.StatusId,
                        principalSchema: "Invite",
                        principalTable: "InviteStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GamePlayerInvites_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalSchema: "Player",
                        principalTable: "Players",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GamePlayerInvites_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GamePlayerInvites_Users_LastModifiedBy",
                        column: x => x.LastModifiedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GamePlayerInvites_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Players", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Players_GamePlayerStatuses_StatusId",
                        column: x => x.StatusId,
                        principalSchema: "Game",
                        principalTable: "GamePlayerStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameComment = table.Column<string>(type: "nvarchar(1050)", maxLength: 1050, nullable: false),
                    TeamId = table.Column<long>(type: "bigint", nullable: false),
                    TeamComment = table.Column<string>(type: "nvarchar(1050)", maxLength: 1050, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameTeamInvites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameTeamInvites_Games_GameId",
                        column: x => x.GameId,
                        principalSchema: "Game",
                        principalTable: "Games",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamInvites_InviteStatuses_StatusId",
                        column: x => x.StatusId,
                        principalSchema: "Invite",
                        principalTable: "InviteStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameTeamInvites_Teams_TeamId",
                        column: x => x.TeamId,
                        principalSchema: "Team",
                        principalTable: "Teams",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamInvites_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamInvites_Users_LastModifiedBy",
                        column: x => x.LastModifiedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamInvites_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TeamId = table.Column<long>(type: "bigint", nullable: false),
                    TeamComment = table.Column<string>(type: "nvarchar(1050)", maxLength: 1050, nullable: false),
                    PlayerId = table.Column<long>(type: "bigint", nullable: false),
                    PlayerComment = table.Column<string>(type: "nvarchar(1050)", maxLength: 1050, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamPlayerInvites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamPlayerInvites_InviteStatuses_StatusId",
                        column: x => x.StatusId,
                        principalSchema: "Invite",
                        principalTable: "InviteStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamPlayerInvites_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalSchema: "Player",
                        principalTable: "Players",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamPlayerInvites_Teams_TeamId",
                        column: x => x.TeamId,
                        principalSchema: "Team",
                        principalTable: "Teams",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamPlayerInvites_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamPlayerInvites_Users_LastModifiedBy",
                        column: x => x.LastModifiedBy,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamPlayerInvites_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teams_TeamIndexes_Index",
                        column: x => x.Index,
                        principalSchema: "Game",
                        principalTable: "TeamIndexes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                schema: "Invite",
                table: "InviteStatuses",
                columns: new[] { "Id", "CreatedDate", "Title" },
                values: new object[,]
                {
                    { 0, new DateTime(2026, 8, 23, 16, 43, 10, 595, DateTimeKind.Utc).AddTicks(7050), "Actual" },
                    { 1, new DateTime(2026, 8, 23, 16, 43, 10, 595, DateTimeKind.Utc).AddTicks(7063), "Accepted" },
                    { 2, new DateTime(2026, 8, 23, 16, 43, 10, 595, DateTimeKind.Utc).AddTicks(7068), "Canceled" },
                    { 3, new DateTime(2026, 8, 23, 16, 43, 10, 595, DateTimeKind.Utc).AddTicks(7074), "Refused" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerInvites_CreatedBy",
                schema: "Invite",
                table: "GamePlayerInvites",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerInvites_GameId",
                schema: "Invite",
                table: "GamePlayerInvites",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerInvites_LastModifiedBy",
                schema: "Invite",
                table: "GamePlayerInvites",
                column: "LastModifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerInvites_PlayerId",
                schema: "Invite",
                table: "GamePlayerInvites",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerInvites_StatusId",
                schema: "Invite",
                table: "GamePlayerInvites",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_GamePlayerInvites_UserId",
                schema: "Invite",
                table: "GamePlayerInvites",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameTeamInvites_CreatedBy",
                schema: "Invite",
                table: "GameTeamInvites",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamInvites_GameId",
                schema: "Invite",
                table: "GameTeamInvites",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamInvites_LastModifiedBy",
                schema: "Invite",
                table: "GameTeamInvites",
                column: "LastModifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamInvites_StatusId",
                schema: "Invite",
                table: "GameTeamInvites",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamInvites_TeamId",
                schema: "Invite",
                table: "GameTeamInvites",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamInvites_UserId",
                schema: "Invite",
                table: "GameTeamInvites",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerInvites_CreatedBy",
                schema: "Invite",
                table: "TeamPlayerInvites",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerInvites_LastModifiedBy",
                schema: "Invite",
                table: "TeamPlayerInvites",
                column: "LastModifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerInvites_PlayerId",
                schema: "Invite",
                table: "TeamPlayerInvites",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerInvites_StatusId",
                schema: "Invite",
                table: "TeamPlayerInvites",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerInvites_TeamId",
                schema: "Invite",
                table: "TeamPlayerInvites",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamPlayerInvites_UserId",
                schema: "Invite",
                table: "TeamPlayerInvites",
                column: "UserId");
