...
namespace SFC.Invite.Infrastructure.Persistence.Migrations.Invite
{
    ...
    [Migration("20250317094311_InviteDbContextMigration")]
    partial class InviteDbContextMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("Invite")
                .HasAnnotation("ProductVersion", "8.0.11")
                .HasAnnotation("Relational:MaxIdentifierLength", 128);

            SqlServerModelBuilderExtensions.UseIdentityColumns(modelBuilder);

            modelBuilder.Entity("SFC.Invite.Domain.Entities.Data.FootballPosition", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Data.GameStyle", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Data.Shirt", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Data.StatCategory", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Data.StatSkill", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Data.StatType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Data.WorkingFoot", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Invite.Data.InviteStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Invite.Team.Player.TeamPlayerInvite", b =>
                {
                    ...
                    b.ToTable("TeamPlayerInvites", "Invite");
                });

            modelBuilder.Entity("SFC.Invite.Domain.Entities.Metadata.Metadata", b =>
                {
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Metadata.MetadataDomain", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Metadata.MetadataService", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Metadata.MetadataState", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Metadata.MetadataType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.Data.TeamPlayerStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnOrder(0);
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.General.TeamAvailability", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.General.TeamFinancialProfile", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.General.TeamGeneralProfile", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.General.TeamShirt", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.General.TeamTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Data.StatType", b =>
                {
                    b.HasOne("SFC.Invite.Domain.Entities.Data.StatCategory", null)
                        .WithMany("Types")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SFC.Invite.Domain.Entities.Data.StatSkill", null)
                        .WithMany("Types")
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Metadata.Metadata", b =>
                {
                    b.HasOne("SFC.Invite.Domain.Entities.Metadata.MetadataDomain", null)
                        .WithMany()
                        .HasForeignKey("Domain")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SFC.Invite.Domain.Entities.Metadata.MetadataService", null)
                        .WithMany()
                        .HasForeignKey("Service")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SFC.Invite.Domain.Entities.Metadata.MetadataState", null)
                        .WithMany()
                        .HasForeignKey("State")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SFC.Invite.Domain.Entities.Metadata.MetadataType", null)
                        .WithMany()
                        .HasForeignKey("Type")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Player.PlayerFootballProfile", b =>
                {
                    ...
                    b.HasOne("SFC.Invite.Domain.Entities.Data.GameStyle", null)
                        .WithMany()
                    ...
                    b.HasOne("SFC.Invite.Domain.Entities.Data.WorkingFoot", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Player.PlayerStat", b =>
                {
                    ...
                    b.HasOne("SFC.Invite.Domain.Entities.Data.StatType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.General.TeamFinancialProfile", b =>
                {
                    b.HasOne("SFC.Invite.Domain.Entities.Team.General.Team", "Team")
                        ...
                        .HasForeignKey("SFC.Invite.Domain.Entities.Team.General.TeamFinancialProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.General.TeamLogo", b =>
                {
                    b.HasOne("SFC.Invite.Domain.Entities.Team.General.Team", "Team")
                        .WithOne("Logo")
                        .HasForeignKey("SFC.Invite.Domain.Entities.Team.General.TeamLogo", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.General.TeamShirt", b =>
                {
                    b.HasOne("SFC.Invite.Domain.Entities.Data.Shirt", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SFC.Invite.Domain.Entities.Team.Player.TeamPlayer", b =>
                {
                    ...
                    b.HasOne("SFC.Invite.Domain.Entities.Team.Data.TeamPlayerStatus", null)
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
