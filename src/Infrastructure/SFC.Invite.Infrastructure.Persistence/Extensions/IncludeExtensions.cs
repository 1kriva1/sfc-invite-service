...
public static class IncludeExtensions
{
    ...
    public static IQueryable<GamePlayerInvite> ThanIncludePlayer(this IQueryable<GamePlayerInvite> gamePlayerInvites)
    {
        IQueryable<GamePlayerInvite> result = gamePlayerInvites
                      .Include(x => x.Player).ThenInclude(p => p.GeneralProfile)
                      .Include(x => x.Player).ThenInclude(p => p.FootballProfile)
                      .Include(x => x.Player).ThenInclude(p => p.Availability)
                      .Include(x => x.Player).ThenInclude(p => p.Availability.Days)
    ...
    public static IQueryable<GamePlayerInvite> ThanIncludeGame(this IQueryable<GamePlayerInvite> gamePlayerInvites)
    {
        IQueryable<GamePlayerInvite> result = gamePlayerInvites
    ...
    public static IQueryable<GameTeamInvite> ThanIncludeTeam(this IQueryable<GameTeamInvite> gameTeamInvites)
    {
        IQueryable<GameTeamInvite> result = gameTeamInvites
                      .Include(x => x.Team).ThenInclude(p => p.GeneralProfile)
                      .Include(x => x.Team).ThenInclude(p => p.FinancialProfile)
                      .Include(x => x.Team).ThenInclude(p => p.InventaryProfile)
                      .Include(x => x.Team).ThenInclude(p => p.Shirts)
    ...
    public static IQueryable<GameTeamInvite> ThanIncludeGame(this IQueryable<GameTeamInvite> gameTeamInvites)
    {
        IQueryable<GameTeamInvite> result = gameTeamInvites
                      .Include(x => x.Game).ThenInclude(p => p.GeneralProfile)
                      .Include(x => x.Game).ThenInclude(p => p.FinancialProfile)
