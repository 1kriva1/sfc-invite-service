...
using SFC.Invite.Infrastructure.Persistence.Configurations.Game.Data;
using SFC.Invite.Infrastructure.Persistence.Configurations.Game.General;
using SFC.Invite.Infrastructure.Persistence.Configurations.Game.Player;
using SFC.Invite.Infrastructure.Persistence.Configurations.Game.Team;
    ...
    : BaseDbContext<GameDbContext>(options, eventsInterceptor), IGameDbContext
{
    ...
    public static void ApplyGameConfigurations(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new GamePlayerStatusConfiguration());
