...
public static class MetadataSeed
{
    public static void SeedMetadata(this ModelBuilder builder, bool isDevelopment)
    {
        ...
        List<MetadataEntity> metadata = [
            ...
            new MetadataEntity { Service = MetadataServiceEnum.Invite, Domain = MetadataDomainEnum.Data, Type = MetadataTypeEnum.Initialization, State = MetadataStateEnum.Required },
            new MetadataEntity { Service = MetadataServiceEnum.Invite, Domain = MetadataDomainEnum.TeamPlayerInvite, Type = MetadataTypeEnum.Seed, State = seedState },
            new MetadataEntity { Service = MetadataServiceEnum.Invite, Domain = MetadataDomainEnum.GamePlayerInvite, Type = MetadataTypeEnum.Seed, State = seedState },
            new MetadataEntity { Service = MetadataServiceEnum.Invite, Domain = MetadataDomainEnum.GameTeamInvite, Type = MetadataTypeEnum.Seed, State = seedState }
        ];
