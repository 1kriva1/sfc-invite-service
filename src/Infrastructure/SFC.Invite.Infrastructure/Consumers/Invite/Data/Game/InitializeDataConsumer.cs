...
using SFC.Invite.Messages.Commands.Game.Data;

namespace SFC.Invite.Infrastructure.Consumers.Invite.Data.Game;
...
public class RequireDataConsumerDefinition : ConsumerDefinition<InitializeDataConsumer>
{
    ...
    private Exchange Exchange { get { return _settings.Exchanges.Invite.Value.Data.Dependent.Game.Initialize; } }

    public RequireDataConsumerDefinition(IConfiguration configuration)
    {
        _settings = configuration.GetRabbitMqSettings();
        EndpointName = "sfc.invite.game.data.initialize.queue";
    }
