...
namespace SFC.Invite.Infrastructure.Consumers.Invite.Data.Data;
...
public class RequireDataConsumerDefinition : ConsumerDefinition<InitializeDataConsumer>
{
    ...
    private Exchange Exchange { get { return _settings.Exchanges.Invite.Value.Data.Dependent.Data.Initialize; } }

    public RequireDataConsumerDefinition(IConfiguration configuration)
    {
        _settings = configuration.GetRabbitMqSettings();
        EndpointName = "sfc.invite.data.data.initialize.queue";
    }
